...
public class BookingServiceApplication extends Application<BookingServiceConfiguration> {

    public static void main(String[] args) throws Exception {
        new BookingServiceApplication().run(args);
    }

    @Override
    public void run(BookingServiceConfiguration configuration, Environment environment) {
