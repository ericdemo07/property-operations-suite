...
public class PricingServiceApplication extends Application<PricingServiceConfiguration> {

    public static void main(String[] args) throws Exception {
        new PricingServiceApplication().run(args);
    }

    @Override
    public void run(PricingServiceConfiguration configuration, Environment environment) {
