...
public class InventoryServiceApplication extends Application<InventoryServiceConfiguration> {

    public static void main(String[] args) throws Exception {
        new InventoryServiceApplication().run(args);
    }

    @Override
    public void run(InventoryServiceConfiguration configuration, Environment environment) {
        ...
        environment.lifecycle().manage(new Managed() {
            ...
            public void start() {
                ...
                EurekaInstanceConfig instanceConfig = new EurekaInstanceConfig() {
                    ...
                    public com.netflix.appinfo.DataCenterInfo getDataCenterInfo() { return new com.netflix.appinfo.MyDataCenterInfo(com.netflix.appinfo.MyDataCenterInfo.Name.MyOwn); }
